namespace BuildHub.DataEngine.Messages
{
    ...
    internal static class DataEngineMessages
    {
        ...
        public readonly static string FAILED_TO_ESTABLISH_CONNECTION_TO_NO_REQUIRED_DATABASE = "Failed to establish a conenction to [NOT REQUIRED] | Source: [{DatabaseSource}]";
