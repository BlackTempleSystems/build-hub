...
namespace BuildHub.Application.Services.Authentication
{
	...
	public interface IAuthenticationService
	{
		...
		public Task<Result<LoginResponse>> AuthenticateUser(LoginRequest loginRequestData);
		...
		public Task<Result<RegisterUserResponse>> RegisterUser(RegisterUserRequest registerUserRequest);
	}
}
